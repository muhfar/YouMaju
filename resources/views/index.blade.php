...
<div class="site-blocks-cover hero-banner overlay" style="background-image: url(images/backk.jpg);"  data-stellar-background-ratio="0.5">
      ...
      <div class="row text-md-left">
        <div class="col-md-6 col-lg-5 mb-5 mb-md-0">
          <h2>CREATE</h2> <h2> CONNECT</h2>	<h2>MAKE AN IMPACT</h2>
    ...
    <div class="site-section block-13">
      ...
      <div class="owl-carousel nonloop-block-13">
        ...
        <div>
          <a href="#" class="unit-1 text-center">
          <iframe width="345" height="190" src="https://www.youtube.com/embed/fg72DS56lwE" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>            <div class="unit-1-text">
           </div>
          </a>
        </div>
        </div>
