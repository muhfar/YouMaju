...
<html lang="en">
  ...
  <link rel="stylesheet" type="text/css" href="{{ asset('css/templatemo-main.css')}}">
...
<!-- navbar -->
  <nav>
          ...
          <a href="{{url('/search')}}"> <img src="{{asset('images/youMaju_polos2.png')}}"></a>
          
          </div>
          <div class="mini-logo">
             
          <a href="{{url('/search')}}"> <img src="{{asset('images/fav_icon_you_maju_YB.png')}}" style="max-width: 50px; margin-bottom:20px;margin-left:-10px"></a>
          
          </div>
          <ul>
            <li><a href="{{url('/search')}}"><i class="fa fa-home"></i> <em>Home</em></a></li>
          ...
          <div class="subs">
            ...
            @if($segment2 != session('idChannelYoutube'))
             <!-- Text Subscribing -->
              ...
              @endif
              <!-- Button Subscribe -->
            <!-- <div class="g-ytsubscribe" data-channelid="<?= $user['idChannelYoutube'] ?>" data-layout="default" data-count="hidden" target"_blank"></div> -->
            <div class="btnsubss">
              @if($subscribe['subscribe'])
                <a type="button" class="btn btn-primary" href="{{ url('profile/unsubscribe')}}/<?= $user['idChannelYoutube'] ?>">Disubscribe</a>
              @else
                <a type="button" class="btn  btn-primary" href="{{ url('profile/subscribe')}}/<?= $user['idChannelYoutube'] ?>">Subscribe</a>
              @endif
            @endif  
            </div>  
